...
function add() {
    ...
    todos.push(task);
    //this converst the task input to a JSON string
...
function show() {
    ...
    //this sets up each task a an unordered list
    var html = '<ul>';
...
function yay() {
    var double = document.getElementById("yay")
    var saythis = "Yay! Great job, I'm super proud of you!"
    double.innerHTML = saythis
}